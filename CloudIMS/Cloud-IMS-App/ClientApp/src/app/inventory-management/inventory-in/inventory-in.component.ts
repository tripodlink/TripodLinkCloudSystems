...
export class InventoryInComponent {
  ...
  constructor(public inv_in_service: InventoryInService, public toastr: ToastrService, public builder: FormBuilder, public auth: UserAuthorizationService,
  ...
  public CreateAutoGeneratedID() {
    this.inv_in_service.getTrxNumFunction().subscribe((result) => {
  ...
  public getUser() {
    ...
    this.auth.getCurrentUser().then(userdata => {
      ...
      this.addInventoryInFormGroup.controls.rcvdBy_hdr.setValue(this.user)
    })
  }
  public CreateForm() {
