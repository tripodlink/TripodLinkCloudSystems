...
var unitCode_component_1 = require("./dictionary/unit-code/unitCode.component");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            declarations: [
                ...
                unitCode_component_1.UnitCodeComponent
            ],
            imports: [
                ...
                router_1.RouterModule.forRoot([
                    ...
                    { path: 'dictionary/unit-code', component: unitCode_component_1.UnitCodeComponent },
                ])
            ],
            providers: [],
