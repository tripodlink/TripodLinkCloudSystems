...
namespace CloudImsCommon.Migrations
{
    ...
    [Migration("20200917095813_UpdateItemMasterAddMinimumStockLevel")]
    partial class UpdateItemMasterAddMinimumStockLevel
    {
            ...
            modelBuilder.Entity("CloudImsCommon.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        new { UserID = "SYSAD", CreatedBy = "SYSTEM", CreatedOn = new DateTime(2020, 9, 17, 17, 58, 12, 696, DateTimeKind.Local), IsActive = (byte)1, Password = ".00000", UpdatedBy = "SYSTEM", UpdatedOn = new DateTime(2020, 9, 17, 17, 58, 12, 697, DateTimeKind.Local), UserName = "SYSTEM ADMINISTRATOR" }
                    );
                });
