...
namespace CloudImsCommon.Migrations
{
    ...
    [Migration("20200906070931_ItemTracking")]
            ...
            modelBuilder.Entity("CloudImsCommon.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        new { UserID = "SYSAD", CreatedBy = "SYSTEM", CreatedOn = new DateTime(2020, 9, 6, 15, 9, 30, 312, DateTimeKind.Local), IsActive = (byte)1, Password = ".00000", UpdatedBy = "SYSTEM", UpdatedOn = new DateTime(2020, 9, 6, 15, 9, 30, 314, DateTimeKind.Local), UserName = "SYSTEM ADMINISTRATOR" }
                    );
                });
