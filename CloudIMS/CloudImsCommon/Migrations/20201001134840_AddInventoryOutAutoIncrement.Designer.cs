...
namespace CloudImsCommon.Migrations
{
    ...
    [Migration("20201001134840_AddInventoryOutAutoIncrement")]
    partial class AddInventoryOutAutoIncrement
    {
            ...
            modelBuilder.Entity("CloudImsCommon.Models.AutoNumber", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { ID = "INVIT", Auto_Length = "8", Current_year = "2020", Date_Prefix = "YY", Last_Value = "1", Text_Prefix = "IT" }
                    );
                });
            ...
            modelBuilder.Entity("CloudImsCommon.Models.InventoryOutTrxDetail", b =>
                {
                    ...
                    b.Property<int>("itoh_ID")
                        .ValueGeneratedOnAdd();

                    b.HasKey("TransactionNo", "ItemID", "In_TrxNo");

                    b.HasAlternateKey("itoh_ID", "TransactionNo");
            ...
            modelBuilder.Entity("CloudImsCommon.Models.ItemMaster", b =>
                {
                    ...
                    b.Property<double>("MinimumStockLevel")
                        .HasColumnName("im_min_stock_lvl");
                    ...
                    b.HasData(
                        new { ID = "01", ItemGroup = "100", ItemName = "Default Item", Manufacturer = "100", MinimumStockLevel = 0.0, Supplier = "100", Unit = "102" }
                    );
                });
            ...
            modelBuilder.Entity("CloudImsCommon.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        new { UserID = "SYSAD", CreatedBy = "SYSTEM", CreatedOn = new DateTime(2020, 10, 1, 21, 48, 40, 454, DateTimeKind.Local), IsActive = (byte)1, Password = ".00000", UpdatedBy = "SYSTEM", UpdatedOn = new DateTime(2020, 10, 1, 21, 48, 40, 455, DateTimeKind.Local), UserName = "SYSTEM ADMINISTRATOR" }
                    );
                });
