...
namespace CloudImsCommon.Migrations
{
    ...
    [Migration("20200422042001_InitialMigration")]
            ...
            modelBuilder.Entity("CloudImsCommon.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        new { UserID = "SYSAD", CreatedBy = "SYSTEM", CreatedOn = new DateTime(2020, 4, 22, 12, 20, 1, 387, DateTimeKind.Local), IsActive = (byte)1, Password = ".00000", UpdatedBy = "SYSTEM", UpdatedOn = new DateTime(2020, 4, 22, 12, 20, 1, 388, DateTimeKind.Local), UserName = "SYSTEM ADMINISTRATOR" }
                    );
                });
