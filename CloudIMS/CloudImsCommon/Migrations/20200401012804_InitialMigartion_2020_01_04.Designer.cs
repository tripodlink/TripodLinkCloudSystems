...
namespace CloudImsCommon.Migrations
{
    ...
    [Migration("20200401012804_InitialMigartion_2020_01_04")]
    partial class InitialMigartion_2020_01_04
    {
            ...
            modelBuilder.Entity("CloudImsCommon.Models.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        new { UserID = "SYSAD", CreatedBy = "SYSTEM", CreatedOn = new DateTime(2020, 4, 1, 9, 28, 3, 715, DateTimeKind.Local), IsActive = (byte)1, Password = ".00000", UpdatedBy = "SYSTEM", UpdatedOn = new DateTime(2020, 4, 1, 9, 28, 3, 716, DateTimeKind.Local), UserName = "SYSTEM ADMINISTRATOR" }
                    );
                });
